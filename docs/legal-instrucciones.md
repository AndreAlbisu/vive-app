...
- [ ] 🔴 **Bloqueo de usuarios.** La guideline 1.2 de Apple exige, para apps con contenido generado por usuarios, las cuatro cosas juntas: filtrado, reporte, **bloqueo de usuarios abusivos** y contacto publicado. Hay reportes (`reports`), no hay bloqueo. Con chat 1 a 1 entre desconocidos, Vita cae de lleno. Cuando exista, mencionarlo en §14.
