...
| **L63** | **Auditoría tanda 6 (23/09, Claude)**: el push del chat mandaba los primeros 50 caracteres del mensaje (y el título del recurso recomendado). Eso se ve en la pantalla bloqueada y viaja a Expo/Apple/Google, y la Política §12 no declara contenido. | ✅ **Cerrado**: el aviso ya no lleva texto del mensaje. ⚠️ **Queda para decidir**: los avisos de reserva sí nombran al profesional (*"Tu sesión con X el 24/09"*), lo que en una pantalla bloqueada revela que la persona está en terapia y con quién. Opciones: dejarlo, o sacar el nombre y dejar solo la fecha. |
