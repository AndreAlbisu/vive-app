...
| **L51** | 📜 **Revisión de fondo de los T&C contra lo que la app hace de verdad, antes de mandárselos al abogado (L5).** Cuatro desajustes, ninguno de redacción: **(a)** §8.3 fija la comisión en 20%/15% y **nunca menciona el 25%/20% del riel internacional**, que está implementado y decidido (D3, 25/08). Un profesional que acepta pagos del exterior firmó 20 y se le cobra 25. **(b)** §8.1 dice que los precios son en pesos y §8.2 que todo pasa por Mercado Pago con la cuenta del propio profesional: en PayPal y USDT **el precio es en dólares y la plata la recibe Vita**, que después le paga. Eso cambia el rol de Vita de intermediario puro a tenedor de fondos de terceros, y §4 la define solo como intermediaria. **(c)** §9.5 promete que si el profesional no llega en 10 minutos **se reintegra la totalidad**, y **no hay nada que lo ejecute**: `session-attendance` solo guarda evidencia. La reserva queda `confirmada` para siempre, la plata ya se liberó y el reintegro depende de que el cliente reclame. **(d)** §8.4 habla de los comprobantes que Vita emite, y **el sistema no emite ninguna factura** (no hay una sola referencia a ARCA en el código). | 🔴 **Abierto. Son decisiones de Andre + el abogado, no código.** Lo que sí se corrigió: la página del botón de arrepentimiento seguía diciendo que la garantía se pide solo por mail, cuando §9.3 cambió el 21/09. 📌 **Lo que se verificó y SÍ coincide**: §9.1 (24hs), §9.2 (cancela el profesional → reembolso automático), §9.3 entera, §8.8 (la garantía no le cuesta comisión a nadie), §15.2 (dice que no hay cifrado de extremo a extremo, y es verdad). | Andre + abogado |
