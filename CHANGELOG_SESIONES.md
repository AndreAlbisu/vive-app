...
**Primera prueba en dispositivo (21/08 19:27) — falló, y quedó con red:**
...
- 🔴 **Volver a probar en dispositivo, con la app de MP instalada**, el camino completo: reservar → salta a MP → pagar → volver → ver "reserva confirmada". Y el caso feo a propósito: **matar la app desde el multitasking mientras se paga**, y verificar que la reserva quede confirmada y el coach notificado igual. Ese es el caso que justifica todo el cambio.
