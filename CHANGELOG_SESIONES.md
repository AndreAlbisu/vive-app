...
- 📝 **Los métodos de cobro del coach siguen siendo UNO a la vez, y está bien.** No hay ningún momento en que alguien elija: el pago es una transferencia semanal que hacemos nosotros, así que varios habilitados obligarían a definir un "principal" igual. Guardar los datos de los otros "por las dudas" es peor que no tenerlos — la pantalla los borra a propósito, porque un destino viejo dando vueltas invita a transferir al lugar equivocado. Tendría sentido solo para **dividir** el pago (60% pesos / 40% dólares), que es otra cosa y además duplica el costo de entrega sobre un monto ya chico.
