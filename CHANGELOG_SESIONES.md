...
- 🔴 **Redeployar las cuatro edge functions tocadas**: `paypal-webhook`, `mp-webhook`, `paypal-create-payment`, `usdt-create-payment`, `session-attendance` (cinco). Ninguna se deployó en esta sesión.
