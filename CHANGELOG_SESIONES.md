...
- **Correr los 2 scripts nuevos en Supabase:** `scripts/fix-resource-recommendations-policies.sql` (cierra el RLS abierto, es el urgente) y `scripts/create-mood-suggestions.sql` (hace que el registro de la tarjeta empiece a funcionar).
