...
**Tocado:** `scripts/add-refund-on-cancel-trigger.sql` (nuevo), `screens/SalaScreen.tsx`, `supabase/functions/mp-webhook/index.ts`, `screens/RegisterScreen.tsx`, `app/_layout.tsx`, `screens/CoachProfileScreen.tsx`, `app/(tabs)/recursos.tsx`, `SCHEMA.md`
