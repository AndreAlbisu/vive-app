...
- **`scripts/create-mood-suggestions.sql`: confirmar que corrió** (`fix-resource-recommendations-policies.sql` ya corrió y está verificado). Sin la tabla, la tarjeta "Para vos ahora" sigue sin registrar — ahora al menos loguea el error en consola.
